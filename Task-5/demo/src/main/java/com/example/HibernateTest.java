...
public class HibernateTest {
    ...
    public static void main(String[] args) {
        ...
        // =======================================================
        // 1. FLYWAY MIGRATION STEP
        // =======================================================

        // Configure Flyway using the same database connection details
        Flyway flyway = Flyway.configure()
                .dataSource("jdbc:postgresql://localhost:5433/ukasha", "postgres", "123456789")
//                .baselineOnMigrate(true)
        ...
        flyway.clean();
        System.out.println("⚠️ Database schema successfully cleaned!");
//         🚨 Executes pending migrations (creates the schema for the first time)
        flyway.migrate();

        System.out.println("✅ Flyway migration successful! Schema is up-to-date.");

        // =======================================================
        // 2. HIBERNATE USAGE (After schema is guaranteed to exist)
        // =======================================================
        ...
        try {
            ...
            newUser.setFirstName("Ukashatu");
            // NOTE: Ensure your port (5433) is correct and the 'ukasha' database exists.
            newUser.setEmail("Ukasha.test." + System.currentTimeMillis() + "@flexisaf.com");
